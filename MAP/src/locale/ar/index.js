const ar = {
  ...
  menu: {
    informationSection: {
      banner:
        'مشروع بروجكت لوكداون لايزال في نسخته التجريبية وقد لا تكون جمع المعلومات متاحة',
      main: {
      ...
      about: {
        ...
        text: {
          ...
          p3:
            '{Project Lockdown} وتلتزم بتزويد مواطني العالم بالأدوات اللازمة للبقاء في أمان وعلى علم بالمُجريات.',
        },
      },
      sources: {
        title: 'المصادر',
      ...
      credits: {
        title: 'الحقوق',
        text:
          '{Project Lockdown} هي مبادرة اجتماعية تقنية نفّذتها مجموعة من الأفراد والمنظمات المتفانية. اطلع على قائمة المساهمين',
        highlight: 'هنا',
      },
      dataPrivacity: {
        ...
        paragraphs: {
          ...
          p2:
            'يتم عرض جميع المعلومات المتوفرة عن العاملين على المشروع بموافقتهم.',
        },
      },
    },
