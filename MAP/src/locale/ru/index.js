const ru = {
  ...
  menu: {
    informationSection: {
      banner:
        'Проект Lockdown в настоящее время находится в бета-версии. Не все данные могут быть доступны.',
      main: {
      ...
      sources: {
        ...
        issues: {
          text:
            'Если вы обнаружите какие-либо ошибки, пожалуйста, помогите нам и сообщите об этом',
      ...
      dataPrivacity: {
        ...
        paragraphs: {
          p1:
            'Мы не собираем конфиденциальную  информацию о наших посетителях.',
          p2:
            'Вся информация об участниках проекта предоставляется с их согласия.',
        },
      },
    },
