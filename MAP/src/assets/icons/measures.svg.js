export const home = (
  <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    ...
    <g>
      <path
        stroke="null"
        d="M9.61 22.116v-7.14h4.78v7.14h5.974v-9.521h3.584L12.001 1.885.052 12.594h3.584v9.52H9.61z"
      />
    </g>
  </svg>
);
...
export const military = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <path d="M393.784 100.106l-95.207-13.834L256 0l-42.577 86.272-95.207 13.834 68.893 67.153-16.264 94.822L256 217.312l85.155 44.769-16.263-94.822z" />
